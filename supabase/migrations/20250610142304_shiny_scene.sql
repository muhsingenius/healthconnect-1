/*
  ...
  1. Sample Questions
    - Insert questions with NULL author_id for sample data
    - Mix of anonymous and named questions
    - Various categories and topics

  2. Sample Answers
    - Insert answers linked to the sample questions
    - Mix of doctor and patient responses
    - NULL author_id for sample data

  3. Notes
    - All sample data uses NULL author_id to avoid foreign key constraints
    - Real user questions will have proper author_id references
    - This provides initial content for the platform
*/
