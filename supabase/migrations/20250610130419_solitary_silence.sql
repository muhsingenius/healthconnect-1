/*
  ...
  1. Sample Data
    - Insert 8 sample questions across different health categories
    - Insert 7 sample answers from doctors and community members
    - Use NULL for author_id to avoid foreign key constraints
    - Link answers to questions using question titles

  2. Categories Covered
    - Diabetes, Preventive Care, Nutrition, Mental Health, General Medicine

  3. Content
    - Realistic medical questions and professional answers
    - Mix of anonymous and named authors
    - Proper tags and categories for each question
*/
